...
noc, now, go  = 0, 0, 0
d = input("Do you like watching football  ").lower()
if d == "yes":
    ...
    if h == "yes":
        ...
        q = input("Q3. Which team in FIFA was the most succesful   ").lower()
        if q == "brazil":
            print("correct answer ")
            go = go + 1
        else:
            print("wrong answer, it is Brazil   ")
        s = int(input("Q4. How many matches did france win in 2018 as an integer  "))
        if s == 5:
            print("correct answer")
            go = go + 1
        else:
            print("wrong answer, it is 5")
        u = input("Q5. where did 2010 world cup be held  ")
        u = u.lower()
        if u == "south africa":
            go = go + 1
            print("correct answer")
...
print("You are a super hero and human-evil is the super-villain")
print("Oh no human-evils minion's minion is coming")
...
root = tk.Tk()
S = tk.StringVar()
E = tk.Entry(root, text = S)
E.grid(columnspan = 4, ipadx = 40)
S.set("this is a simple calclator")
tk.Button(root, text = " 1 ", width = 7, command = lambda: number("1")).grid(row = 1, column = 0)
tk.Button(root, text = " 2 ", width = 7, command = lambda: number("2")).grid(row = 1, column = 1)
tk.Button(root, text = " 3 ", width = 7, command = lambda: number("3")).grid(row = 1, column = 2)
tk.Button(root, text = " 4 ", width = 7, command = lambda: number("4")).grid(row = 1, column = 3)
tk.Button(root, text = " 5 ", width = 7, command = lambda: number("5")).grid(row = 2, column = 0)
tk.Button(root, text = " 6 ", width = 7, command = lambda: number("6")).grid(row = 2, column = 1)
tk.Button(root, text = " 7 ", width = 7, command = lambda: number("7")).grid(row = 2, column = 2)
tk.Button(root, text = " 8 ", width = 7, command = lambda: number("8")).grid(row = 2, column = 3)
tk.Button(root, text = " 9 ", width = 7, command = lambda: number("9")).grid(row = 3, column = 0)
tk.Button(root, text = " 0 ", width = 7, command = lambda: number("0")).grid(row = 3, column = 1)
tk.Button(root, text = " + ", width = 7, command = lambda: number("+")).grid(row = 3, column = 2)
tk.Button(root, text = " - ", width = 7, command = lambda: number("-")).grid(row = 3, column = 3)
tk.Button(root, text = " * ", width = 7, command = lambda: number("*")).grid(row = 4, column = 0)
tk.Button(root, text = " / ", width = 7, command = lambda: number("/")).grid(row = 4, column = 1)
tk.Button(root, text = " = ", width = 7, command = lambda: bald()).grid(row = 4, column = 2)
tk.Button(root, text = "clear", width = 7, command = lambda: screen()).grid(row = 4, column = 3)
root.mainloop()